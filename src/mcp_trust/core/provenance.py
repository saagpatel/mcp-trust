...
# Shared public wording for every HTML projection of stub-derived grades.
# Keeping this beside classification prevents live and static surfaces from
# drifting on the claim attached to the same synthetic record.
DEMO_DISCLOSURE = (
